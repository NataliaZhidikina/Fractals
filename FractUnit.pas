...
type
  TForm3 = class(TForm)
    ...
    Шестикутник: TRadioButton;
    Семикутник: TRadioButton;
    Восьмикутник: TRadioButton;
    ...
    procedure ШестикутникClick(Sender: TObject);
    procedure СемикутникClick(Sender: TObject);
    procedure ВосьмикутникClick(Sender: TObject);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            // Раскрашиваем (изменяя множителm меняем цвет)
            if zm < l then
              Pixels[x, y] := clblack
            else
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          rX1 := x11 + (tgx / Image1.Width) * x;
          // Приводим х к координатам декарта
          for y := 0 to Image1.Height do // Перебераем точки по у
          begin
            rY1 := Y11 + (tgy / Image1.Height) * y;
            // Приводим у к координатам декарта
            zr := rX1;
            zi := rY1;
            zm := 0;
            for cc := 0 to n do
...
procedure TForm3.ВосьмикутникClick(Sender: TObject);
begin
  i := 43;
  figure := 8;
  DrowMultiFigure2;
...
procedure TForm3.СемикутникClick(Sender: TObject);
begin
  i := 42;
  figure := 7;
  DrowMultiFigure2;
...
procedure TForm3.ШестикутникClick(Sender: TObject);
begin
  i := 41;
  figure := 6;
  DrowMultiFigure2;
